<li class="uk-grid-margin">
    ...
    <a class="uk-display-block uk-panel-card-hover uk-panel-box uk-panel-space" href="{{ $app['site_url'] }}" target="_blank" title="@lang('Open website in new tab')" data-uk-tooltip>
